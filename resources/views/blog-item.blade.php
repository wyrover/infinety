...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prettify/r298/prettify.min.css">
...
<div class="container content">
    <div class="row">
        <div class="section">
            <h4 style="border-bottom: 1px solid #c8c8c8;">{!! ucwords($post->title) !!}</h4>
